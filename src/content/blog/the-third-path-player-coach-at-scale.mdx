...
Two years ago at Pocketlaw (Legal Tech), I was Lead AI Engineer with a team of one junior developer. A traditional company would have staffed that function with 3-5 people and made me a pure manager—roadmap ownership, sprint planning, 1:1s, stakeholder alignment, maybe a Jira board to groom. Instead, I shipped.
...
I've been writing about adjacent ideas before. If this post intrigues you, note that my thinking has evolved over time. I recommend checking out these earlier posts for more context:
...
Should you be a *specialist*, or should you be a *generalist* or a little bit of both? Different people have different opinions here, however the discourse right now says AI coding tools are bifurcating engineering careers. But at the same time, anyone can now be a **10x** engineer with AI assistance.
...
Here's what bothers me about this framing: it assumes the **IC/manager** split was ever natural. It wasn't. It was a bandwidth hack. For instance, many managers at the current AI-driven companies code quite a bit, but not at the same level as before.
...
What AI tools change isn't just individual productivity—they change the **leverage equation** that forced this tradeoff in the first place. Both for technically skilled people, but also for other crafts like design, marketing, and writing.
...
However, in my mind, a Player-Coach—although similar—is not a "Unicorn," a term I've never liked:
...
For me it has been a lot around having high throughput shipping backend services, scoping the product, setting the AI vision, doing AI engineering, managing stakeholders, talking to and meeting clients and understanding their needs. I'm in no way super-human or, for that matter, a unicorn. I'm only good at leveraging my context and AI tools to amplify my impact—which I expect is similar to many seasoned leads out there right now.
</Callout>
...
Having been around for some time now I've had the opportunity to see how this plays out for different career stages. For instance the worst thing you could do is to trust blindly on AI tools output and do "Vibe Coding" instead of "Vibe Engineering". Then one of your peers would have to spend hours cleaning up. Meaning a loss of confidence for the future.
